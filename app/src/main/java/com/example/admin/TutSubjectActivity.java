...
import com.example.admin.databinding.ActivityTutSubjectBinding;

import java.util.ArrayList;

public class TutSubjectActivity extends AppCompatActivity {

    ActivityTutSubjectBinding binding;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityTutSubjectBinding.inflate(getLayoutInflater());
